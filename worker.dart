...
List<Map<String, dynamic>> workers = [
  {
    'name': 'abc',
    'image':
        'https://w7.pngwing.com/pngs/328/335/png-transparent-icon-user-male-avatar-business-person-profile-thumbnail.png',
    'department': 'abc',
    'wage': 10
  },
  {
...
List<Worker> abc = workers.map((e) => Worker.fromJson(e)).toList();
...
class _MyHomePageState extends State<Workers> {
  ...
  delete_data() async {
    await firestore.doc('workers/yJOGPoO4IiGco77IAu61').delete();
  }
}
